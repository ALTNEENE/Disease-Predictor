...
function isLocalUrl(value) {
  return /^(https?|mongodb(?:\+srv)?):\/\/(localhost|127\.0\.0\.1)(:\d+)?(\/|$)/i.test(value || "");
}
...
const env = {
  ...
  clientUrl: productionUrl("CLIENT_URL", "*"),
  mongoUri: productionUrl("MONGODB_URI", isProduction ? "" : "mongodb://localhost:27017/disease_prediction"),
